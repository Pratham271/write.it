...
const EmailOtp = ({onChange,onClick}:{onChange:(e:ChangeEvent<HTMLInputElement>)=>void,onClick:()=>void}) => {
  return (
    <>
    ...
    <div className="flex items-center mt-1">
        <div className="relative w-full flex">
            <input onChange={onChange} type="text"  className="rounded-md block p-2.5 w-full z-20 text-sm text-gray-900 bg-white border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="johndoe@gmail.com" required />
